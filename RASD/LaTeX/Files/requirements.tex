...
\item \textbf{G6} AutomatedSOS must notify the user and call an ambulance when it detects a health emergency
\begin{itemize}
...
\textbf{G9} Track4Run allows a spectator to track the position of the partecipants of the run
\begin{itemize}
